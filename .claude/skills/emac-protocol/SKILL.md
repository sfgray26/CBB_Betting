...
## Operator Profiles
1. **Claude Code (Master Architect)**: You. Domain: Algorithms, TDD, edge-case mitigation. Authority: Final.
...
- **System-Mediated Handoffs.** All technical tasks for Kimi/OpenClaw/Gemini must use `.claude/delegation/` JSON bundles.
