...
**Generated:** 2026-04-21 21:00 ET
**Total Checks:** 81
**PASS:** 78  |  **FAIL:** 1  |  **WARN:** 2  |  **SKIP:** 0
...
| GET /api/fantasy/roster | 200 | 672 | 10 | 0 | 0 |
| GET /api/fantasy/matchup | 200 | 655 | 10 | 0 | 0 |
| GET /api/fantasy/scoreboard | 200 | 563 | 7 | 0 | 0 |
| GET /api/fantasy/budget | 200 | 500 | 13 | 0 | 0 |
| POST /api/fantasy/roster/optimize | 500 | 280 | 0 | 1 | 0 |
| GET /api/fantasy/waiver | 503 | 875 | 0 | 0 | 1 |
| GET /api/fantasy/lineup/2026-04-21 | 200 | 16155 | 8 | 0 | 1 |
| GET /api/fantasy/briefing/2026-04-21 | 200 | 1688 | 5 | 0 | 0 |
| GET /api/fantasy/players/1/scores | 200 | 108 | 4 | 0 | 0 |
| GET /api/fantasy/decisions | 200 | 171 | 17 | 0 | 0 |
| GET /api/fantasy/decisions/status | 200 | 109 | 2 | 0 | 0 |

## FAILURES (must fix)

| # | Endpoint | Check | Expected | Actual | Detail |
|---|----------|-------|----------|--------|--------|
| 1 | POST /api/fantasy/roster/optimize | http_status | 200 | 500 |  |
...
| PASS | ip_pace_valid | one of {'COMPLETE', 'ON_TRACK', 'BEHIND'} | 'BEHIND' |
| PASS | freshness_present | dict | dict |
...
| PASS | overall_confidence | 0-1 float | 0.26 |
...
|--------|-------|----------|--------|
| PASS | http_status | 200 | 200 |
| PASS | verdict_valid | one of {'partial', 'healthy', 'missing', 'stale'} | 'healthy' |
