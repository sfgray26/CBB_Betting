...
**Generated:** 2026-04-22 06:13 ET
**Total Checks:** 99
**PASS:** 98  |  **FAIL:** 0  |  **WARN:** 1  |  **SKIP:** 0

## Summary by Endpoint

| Endpoint | HTTP | Time (ms) | PASS | FAIL | WARN |
|----------|------|-----------|------|------|------|
| GET /health | 200 | 327 | 2 | 0 | 0 |
| GET /api/fantasy/roster | 200 | 2984 | 10 | 0 | 0 |
| GET /api/fantasy/matchup | 200 | 1405 | 10 | 0 | 0 |
| GET /api/fantasy/scoreboard | 200 | 1047 | 7 | 0 | 0 |
| GET /api/fantasy/budget | 200 | 1344 | 13 | 0 | 0 |
| POST /api/fantasy/roster/optimize | 200 | 12765 | 11 | 0 | 0 |
| GET /api/fantasy/waiver | 200 | 19217 | 9 | 0 | 0 |
| GET /api/fantasy/lineup/2026-04-22 | 200 | 9734 | 8 | 0 | 1 |
| GET /api/fantasy/briefing/2026-04-22 | 200 | 3657 | 5 | 0 | 0 |
| GET /api/fantasy/players/1/scores | 200 | 125 | 4 | 0 | 0 |
| GET /api/fantasy/decisions | 200 | 202 | 17 | 0 | 0 |
| GET /api/fantasy/decisions/status | 200 | 125 | 2 | 0 | 0 |

## WARNINGS (should investigate)

| # | Endpoint | Check | Expected | Actual | Detail |
|---|----------|-------|----------|--------|--------|
| 1 | GET /api/fantasy/lineup/2026-04-22 | lineup_warnings | empty ideally | 12 warnings: ['Hyeseong Kim: No game scheduled — monitor before lock', 'Munetaka Murakami: No game scheduled — monitor before lock'] | Lineup produced warnings |
...
| PASS | total_lineup_score | numeric > 0 | 1050.5 |
| PASS | freshness_present | dict | dict |
...
| PASS | matchup_opponent | non-TBD name | "Bartolo's Colon" |
| PASS | category_deficits_present | >0 categories | 18 |
...
| PASS | games_count_present | int >= 0 | 11 |
...
| PASS | overall_confidence | 0-1 float | 0.27 |
...
|--------|-------|----------|--------|
| PASS | http_status | 200 | 200 |
| PASS | score_0_100_range | 0-100 | 20.5 |
| PASS | composite_z_present | numeric | -2.2789586654243568 |
...
|--------|-------|----------|--------|
| PASS | http_status | 200 | 200 |
| PASS | verdict_valid | one of {'missing', 'stale', 'healthy', 'partial'} | 'healthy' |
