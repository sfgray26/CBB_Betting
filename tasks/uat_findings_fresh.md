...
| GET /api/fantasy/roster | 200 | 516 | 5 | 5 | 0 |
| GET /api/fantasy/matchup | 200 | 641 | 8 | 1 | 1 |
| GET /api/fantasy/scoreboard | 404 | 108 | 0 | 1 | 0 |
| GET /api/fantasy/budget | 404 | 108 | 0 | 1 | 0 |
| POST /api/fantasy/roster/optimize | 404 | 93 | 0 | 1 | 0 |
| GET /api/fantasy/waiver | 200 | 1438 | 7 | 2 | 0 |
| GET /api/fantasy/lineup/2026-04-20 | 200 | 1015 | 8 | 0 | 1 |
| GET /api/fantasy/briefing/2026-04-20 | 200 | 1046 | 2 | 3 | 0 |
| GET /api/fantasy/players/1/scores | 200 | 203 | 4 | 0 | 0 |
...
| 6 | GET /api/fantasy/matchup | all_stat_values_numeric | all numeric | 2 non-numeric: ["my.NSB='0/0'", "opp.NSB='0/0'"] |  |
...
| 12 | GET /api/fantasy/briefing/2026-04-20 | categories_present | >0 | 0 |  |
| 13 | GET /api/fantasy/briefing/2026-04-20 | starters_present | >0 | 0 |  |
| 14 | GET /api/fantasy/briefing/2026-04-20 | overall_confidence | 0-1 float | 95 |  |
...
| # | Endpoint | Check | Expected | Actual | Detail |
|---|----------|-------|----------|--------|--------|
| 1 | GET /api/fantasy/matchup | stat_keys_recognized | all recognized | unknown: {'OBP', 'K/BB'} | Non-canonical stat keys in matchup |
...
| PASS | opponent_has_stats | >0 stats | 14 stats |
| WARN | stat_keys_recognized | all recognized | unknown: {'OBP', 'K/BB'} |
| **FAIL** | all_stat_values_numeric | all numeric | 2 non-numeric: ["my.NSB='0/0'", "opp.NSB='0/0'"] |
...
| PASS | decision[2].confidence | present | 0.907 |
| PASS | decision[3].bdl_player_id | present | 69 |
| PASS | decision[3].decision_type | present | 'waiver' |
| PASS | decision[3].confidence | present | 0.9033 |
| PASS | decision[4].bdl_player_id | present | 4667586 |
| PASS | decision[4].decision_type | present | 'lineup' |
| PASS | decision[4].confidence | present | 0.895 |
...
{
  "date": "2026-04-20",
  "generated_at": "2026-04-20T12:31:29.223386",
  "strategy": "standard",
